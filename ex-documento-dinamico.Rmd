...
# necessário utilizar arquivo completo "data-raw/servidoresMG_1219.csv" para
# manipulação com filter() e top_n() ser necessária
...
dat %>%
  ...
  group_by(orgao) %>%
  summarize(
    vl_mediana = median(vl_remuneracao_liquida),
    n = n()
  ) %>%
